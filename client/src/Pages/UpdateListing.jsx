    ...
    <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4' >
        ...
        <div className='flex flex-col gap-4 flex-1'>
            ...
            <div className="flex flex-wrap gap-6">
                <div className="div items-center gap-2">
                ...
                <div className="div items-center gap-2">
                    <input type="number" id='bathrooms' min='1' max='10'  required className='p-3 border border-grey-300 rounded-lg' onChange={handleChange} checked={formData.bathrooms}/>
                    <p>Baths</p>
                </div>

                <div className="div items-center gap-2">
                    <input type="number" id='regularPrice' min='50' max='100000'  required className='p-3 border border-gray-300 rounded-lg' onChange={handleChange} checked={formData.regularPrice}/>
                ...
                <div className="div items-center gap-2">
                    ...
                    <div className='flex flex-col items-center' onChange={handleChange} checked={formData.discountPrice}>
        ...
        <div className='flex flex-col flex-1 gap-4'>  
            ...
            <span className='font-normal text-gray-600 ml-2'>The first image will be the cover page (max 6)</span></p>
            <p>
                <div className="flex gap-4">
                    ...
                    <button type='button'disabled={uploading} onClick={handleImageSubmit} className='p-3 text-green-700 border border-green-700 rounded uppercase hover:shadow-large disabled:opacity-80'>{uploading?'Uploading...':'Upload'}</button>
                </div>
            </p>
