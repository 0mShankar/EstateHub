  ...
  return (
    <div className='p-3 max-w-lg mx-auto'>
      ...
      <div className='flex justify-between mt-5'>
        ...
        <button onClick={handleShowListings} className='text bg-green-700 w-full rounded-lg'>Show Listings</button>
             ...
             <div className="flex flex-col gap-4 ">
              ...
              {userListings.map((listing)=>
                <div key={listing._id} className='border rounded-lg p-3 flex justify-between items-center gap-4'> 
                    ...
                    <Link to={`/listing/${listing._id}`}><p >{listing.name}</p></Link>

                    <div className="flex flex-col">
                        <button onClick={()=>handleListeningDelete(listing._id)} className='text-red-700 uppercase'>Delete</button>
